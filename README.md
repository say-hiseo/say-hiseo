...
<img src="https://capsule-render.vercel.app/api?type=blur&color=0:1afbff,100:ff66de&height=250&section=header&text=Hi!%20Seo's%20GitHub&fontSize=50&fontColor=ffffffee&stroke=8888bb&strokeWidth=1.5&fontAlignY=40&desc=Huiseo%20Park&descAlignY=60&descSize=20&descColor=ffffffcc" width="100%"/>

<!-- Introduction -->
<div align="center">
  <h3>👋 안녕하세요, 개발자 박희서입니다</h3>
  <p>소통을 통해 함께 성장하는 팀, 그리고 그 안에서 더 나은 서비스를 위해<br/>
  새로운 기술을 탐구하고 끊임없이 발전해나가는 개발자입니다.</p>
</div><br/>
...
**🥇 Awards**
- **2024.11.29** 삼성 청년 SW 아카데미 자율 프로젝트 우수상 — AI 기반 탈모 및 두피 케어 서비스
- **2023.02.21** 대경권 SW 산학프로젝트 경진대회 우수상 — GPS 기반 익명 패션 SNS 프로젝트

**📜 Certifications**
- **2026.04.18** Coding Specialist Professional 1급 (Java) — YBM IT
- **2025.09.12** 정보처리기사 — 한국산업인력공단
- **2025.03.28** 리눅스마스터 2급 — 한국정보통신진흥협회
- **2024.06.21** SQL 개발자 (SQLD) — 한국데이터산업진흥협회
...
- **2024.01 ~ 2024.12** 삼성 청년 SW 아카데미 (SSAFY) 11기 Java 전공 트랙 수료
- **2018.03 ~ 2024.02** OO대학교 컴퓨터공학과 졸업
...
<!-- Footer -->
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:ff66de,100:1afbff&height=120&section=footer" width="100%"/>
</div>
